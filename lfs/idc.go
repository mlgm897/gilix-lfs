...
//自定义
//IDC_QUERY_FORM
type LFSIDCQUERYFORM struct {
	FormName string
}

//IDC_FORM_LIST
type LFSIDCFORMLIST struct {
	FormList []byte
}
...
//自定义
//IDC_READ_RAW_DATA
type LFSIDCREADRAWDATA struct {
	ReadDataIn uint
}

//IDC_RESET
type LFSIDCRESET struct {
	ResetIn uint
}

//IDC_READ_TRACK
type LFSIDCREADTRACK struct {
	TrackData string
}

//IDC_PARSE_DATA
type LFSIDCPARSEDATAEX struct {
	TrackData string
}
...
type SlotUnitInfo []LFSIDCSLOTUNITINFO
